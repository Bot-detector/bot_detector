...
from bot_detector.player.database.structs import PlayersTableStruct as dbPlayer
from bot_detector.prediction.database.prediction import (
    Prediction_v2 as dbPrediction,
)
from bot_detector.feedback.database import PredictionFeedback as dbFeedback
from bot_detector.player.structs import PlayerCreate, PlayerInDB
