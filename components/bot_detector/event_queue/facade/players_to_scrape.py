...
class PlayersToScrapeProducer(BaseProducerFacade[ToScrapeStruct]):
    def __init__(
        self,
...
class PlayersToScrapeConsumer(BaseConsumerFacade[ToScrapeStruct]):
    def __init__(
        self,
        group_id: str,
        bootstrap_servers: str | None,
...
class PlayersToScrapeQueue(BaseQueueFacade[ToScrapeStruct]):
    def __init__(
        self,
        group_id: str,
        bootstrap_servers: str | None,
