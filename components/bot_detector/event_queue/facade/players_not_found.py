...
class PlayersNotFoundProducer(BaseProducerFacade[NotFoundStruct]):
    def __init__(
        self,
...
class PlayersNotFoundConsumer(BaseConsumerFacade[NotFoundStruct]):
    def __init__(
        self,
        group_id: str,
        bootstrap_servers: str | None,
...
class PlayersNotFoundQueue(BaseQueueFacade[NotFoundStruct]):
    def __init__(
        self,
        group_id: str,
        bootstrap_servers: str | None,
